...
confusing ourselves.
% TODO: We use $\lnot A$ rather than $A^\bot$.
...
% TODO: Reflecting new insights,
% - replace "activation records" with "channels",
% - have each construct return a value *and* a set of named channels;
% - and rewrite all A.R.-related explanations.
% (Also, add "switch channel" construct.)
...
% TODO: The 'let' construct (the 'cut' rule).
